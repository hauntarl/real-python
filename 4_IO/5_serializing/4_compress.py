'''
How to compress and decompress your pickled objects using the bz2 module
'''
import pickle
import bz2
...
print(f'length lorem: {len(lorem)}')
print(f'length pickled: {len(pickled)}')
print(f'length compressed: {len(compressed)}')

decompressed = bz2.decompress(compressed)
unpickled = pickle.loads(decompressed)
print(f'length decompressed: {len(decompressed)}')
print(f'length unpickled: {len(unpickled)}')
