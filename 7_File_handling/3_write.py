...
with open('D:/real_python/7_File_handling/new_file.txt', 'w') as file:
...
with open('D:/real_python/7_File_handling/new_file.txt', 'r') as file:
...
with open('D:/real_python/7_File_handling/file.txt', 'r') as src, open('D:/real_python/7_File_handling/file_caps.txt', 'w') as dst:
...
with open('D:/real_python/7_File_handling/file_caps.txt', 'r') as file:
...
with open('D:/real_python/7_File_handling/new_file.txt', 'a') as file:
